...
MagicItem::MagicItem(){                                                         //Default constructor
...
int MagicItem:: getAnswer(){                                                    //Gets the answer when called upon.
    return _answer;
}


string MagicItem::getPattern() {                                                //Prints the pattern to be solved.
    cout << pattern;
    return pattern;
}

string MagicItem::getPrize(){                                                   //Gets the prize when called.
    return prize;
}

void MagicItem::introduction(){                                                 //Prints the introduction
    cout << "Guess what the next number in the pattern is to win a prize!";
    return;
}

int MagicItem::setAnswer(int numToCheck){                                       //Sets the answer if it is a number
...
bool MagicItem::correct(){                                                      //Checks if the user input is equals the answer to the pattern
    if(_answer == _result){
        return true;
    }
    else{
...
void MagicItem::solution(){                                                     //prints the solution. called when user is wrong.
...
void getTheAnswer(MagicItem& thing){                                            // gets the users input and calls to set it.
    int temp;
...
void printResults(MagicItem& thing){                                            //Prints the results of the user's input.
    if (thing.correct() == true){
         cout << "You won " << thing.getPrize();
     }
     else{
